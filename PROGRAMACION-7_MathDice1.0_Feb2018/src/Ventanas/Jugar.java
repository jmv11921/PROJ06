...
public class Jugar extends JFrame {
	...
	//private static final long serialVersionUID = 8422513638129088921L;

	/**
	 * 
	 */
	private static final long serialVersionUID = 5209673349116230454L;
	//Atributos
...
//private ImageIcon dadogris = new ImageIcon(getClass().getResource("img/dado_gris.png"));
	...
	public Jugar() {
		...
		JtextField_Operacion.setBounds(220, 219, 204, 32);
	...
	private void inicializarDados() {
		...
		ImageIcon dado = new ImageIcon(getClass().getResource("/img/dadogris.png"));
		...
		//Rellenamos el array numAleatorio
				...
				//Añadimos los MouseListeners a cada dado para cuando se pulse sobre este
...
if(tocaNumero){
	...
	tocaNumero=false;													
	tocaOperacion=true;
	txtComentarios.setText(txtComentarios.getText() + String.valueOf(valorDado));
	...
	// Acción a realizar al hacer click
		...
		if(tocaOperacion){
			if(operacion.getName()=="Resta"){							
				tocaSumar=false;
				tocaRestar=true;
				txtComentarios.setText(txtComentarios.getText() + "-"); 			//Añadimos el símbolo de la resta a la caja de texto
			}
			else if(operacion.getName()=="Suma"){
				tocaSumar=true;
				tocaRestar=false;
				txtComentarios.setText(txtComentarios.getText() + "+"); 			//Añadimos el símbolo de la suma a la caja de texto
			}
